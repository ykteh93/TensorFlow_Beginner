...
<dl>
  ...
  <dd> B: input &rarr; hidden layer (128 units) &rarr; linear layer &rarr; softmax &rarr; class probabilities</dd>
  <dd> C: input &rarr; non-linear layer &rarr; linear layer &rarr; softmax &rarr; class probabilities</dd>
</dl>
